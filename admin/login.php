<?php
	...
	$user = 'SELECT * FROM administrator WHERE Administrator_id = "'.$username.'"';
	...
	else
	{
		...
		$data = 'SELECT * FROM administrator WHERE Administrator_id = "'.$username.'"';
		...
		if($Administrator_password != md5($password))
		{
